...
class DocType(Tag):
    def __init__(self):
        super(DocType, self).__init__('!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN http://www.w3.org'
                                      '/TR/html4/strict.dtd"', '')
        self.end_tag = ''
...
if __name__ == '__main__':
    ...
    # my_page.add_tag('p', 'This is a program that will appear on the screen')
