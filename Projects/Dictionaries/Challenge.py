# /home/mohsen/IdeaProjects/PythonPrograms/Dictionaries/054.png
# modify the program so that the exits is a dictionary rather than a list,
# with tha keys of being the numbers of the locations and the values being
...
# plays my use. These words will be the keys, and their values will be
...
while True:
    ...
    if loc == 0:
        break
    direction = input("Available directions are : " + availableExits).upper()
    print()
    if len(direction) > 1:
