...
print("The naive local time is {}".format(local_time))
print("The naive UTC time is {}".format(utc_time))
...
print("{} second since the epoch is {}".format(s, dt1))
print("{} second since the epoch is {}".format(t, dt2))
